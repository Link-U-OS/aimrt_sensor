...
It's recommended that you signal your intention to contribute in the issue tracker, either by claiming an [existing one](https://github.com/Link-U-OS/aimrt_process_manager/issues) or by [opening a new issue](https://github.com/Link-U-OS/aimrt_process_manager/issues/new).

### Checking the issue tracker

Whether you already know what contribution to make, or you are searching for an idea, the [issue tracker](https://github.com/Link-U-OS/aimrt_process_manager/issues) is always the first place to go.
...
- **NeedsDecision**: The issue is relatively well understood, but the aimrt_process_manager team hasn't yet decided the best way to address it.
...
1. What version of aimrt_process_manager are you using?
...
Commit messages in aimrt_process_manager follow a specific set of conventions, which we discuss in this section.
...
A rule of thumb is that it should be written so to complete the sentence "This change modifies aimrt_process_manager to _____."
...
Write in complete sentences with correct punctuation, just like for your comments in aimrt_process_manager.
Don't use HTML, Markdown, or any other markup language.
Add any relevant information, such as benchmark data if the change affects performance.

#### Referencing issues

The special notation "Fixes #12345" associates the change with issue 12345 in the aimrt_process_manager issue tracker.
When this change is eventually applied, the issue tracker will automatically mark the issue as fixed.

## Copyright headers

Files in the aimrt_process_manager repository don't list author names, both to avoid clutter and to avoid having to keep the lists up to date.
